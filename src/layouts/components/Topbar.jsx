      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <span style={{ fontSize: '10px', color: 'var(--text-tertiary)', fontWeight: 600, marginTop: '1px' }}>
      ...
      <div className="flex items-center gap-1.5 ml-auto" style={{ marginLeft: 'auto' }}>
        ...
        <Dropdown
          trigger={
            ...
            >
              <Avatar name={currentUser?.name || 'Sarah Jenkins'} src={currentUser?.avatar} size="sm" status="online" />
              <div className="hidden-mobile flex flex-col text-left">
                <span className="font-bold text-xs text-primary leading-tight">{currentUser?.name || 'Sarah Jenkins'}</span>
        ...
        >
          <DropdownHeader>
            <div className="flex flex-col gap-1 py-0.5">
              <span className="font-bold text-xs text-primary">{currentUser?.name || 'Sarah Jenkins'}</span>
              <span className="text-tertiary text-xs">{currentUser?.role || 'Sales Manager'}</span>
            </div>
          </DropdownHeader>
